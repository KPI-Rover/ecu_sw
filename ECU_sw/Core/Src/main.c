...
/* Definitions for logDataBuffer */
osMessageQueueId_t logDataBufferHandle;
const osMessageQueueAttr_t logDataBuffer_attributes = {
  .name = "logDataBuffer"
};
/* Definitions for UART3_Events */
osEventFlagsId_t UART3_EventsHandle;
const osEventFlagsAttr_t UART3_Events_attributes = {
  .name = "UART3_Events"
};
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_SerialLogTask */
/**
