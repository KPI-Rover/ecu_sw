...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SPI1_CS_IMU_Pin|R2_Pin|F2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, BUZZER_Pin|R4_Pin|F4_Pin|R3_Pin
                          |F3_Pin|TRIG1_Pin|TRIG2_Pin|TRIG3_Pin
  ...
  /*Configure GPIO pins : SPI1_CS_IMU_Pin R2_Pin F2_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_IMU_Pin|R2_Pin|F2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : BUZZER_Pin R4_Pin F4_Pin R3_Pin
                           F3_Pin TRIG1_Pin TRIG2_Pin TRIG3_Pin
                           TRIG4_Pin */
  GPIO_InitStruct.Pin = BUZZER_Pin|R4_Pin|F4_Pin|R3_Pin
                          |F3_Pin|TRIG1_Pin|TRIG2_Pin|TRIG3_Pin
                          |TRIG4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
