...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PC1     ------> ADC1_IN11
    */
    GPIO_InitStruct.Pin = POWER_SUPPLY_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(POWER_SUPPLY_ADC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC1     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(POWER_SUPPLY_ADC_GPIO_Port, POWER_SUPPLY_ADC_Pin);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  if(htim_ic->Instance==TIM1)
  {
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = ENC1_A_Pin|ENC1_B_Pin|US_SENSOR1_ECHO_Pin|US_SENSOR2_ECHO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = MOTOR3_PWM_Pin|MOTOR4_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  if(htim_ic->Instance==TIM1)
  {
    ...
    PE14     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOE, ENC1_A_Pin|ENC1_B_Pin|US_SENSOR1_ECHO_Pin|US_SENSOR2_ECHO_Pin);
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  if(htim_pwm->Instance==TIM2)
  {
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOA, ENC2_B_Pin|MOTOR1_PWM_Pin|MOTOR2_PWM_Pin|ENC2_A_Pin);
  ...
  else if(htim_pwm->Instance==TIM3)
  {
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, MOTOR3_PWM_Pin|MOTOR4_PWM_Pin|ENC3_B_Pin);
